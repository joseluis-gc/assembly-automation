            ...
            ?>
                <tr>
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 6);" data-item='<?php echo $row['pn_6'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="6" type="button" id="6" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 7);" data-item='<?php echo $row['pn_7'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="7" type="button" id="7" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 8);" data-item='<?php echo $row['pn_8'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="8" type="button" id="8" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 9);" data-item='<?php echo $row['pn_9'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="9" type="button" id="9" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 10);" data-item='<?php echo $row['pn_10'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="10" type="button" id="10" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 11);" data-item='<?php echo $row['pn_11'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="11" type="button" id="11" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 12);" data-item='<?php echo $row['pn_12'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="12" type="button" id="12" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 13);" data-item='<?php echo $row['pn_13'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="13" type="button" id="13" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 14);" data-item='<?php echo $row['pn_14'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="14" type="button" id="14" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 15);" data-item='<?php echo $row['pn_15'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="15" type="button" id="15" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 16);" data-item='<?php echo $row['pn_16'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="16" type="button" id="16" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 17);" data-item='<?php echo $row['pn_17'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="17" type="button" id="17" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 18);" data-item='<?php echo $row['pn_18'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="18" type="button" id="18" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 19);" data-item='<?php echo $row['pn_19'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="19" type="button" id="19" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 20);" data-item='<?php echo $row['pn_20'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="20" type="button" id="20" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 21);" data-item='<?php echo $row['pn_21'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="21" type="button" id="21" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 22);" data-item='<?php echo $row['pn_22'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="22" type="button" id="22" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 23);" data-item='<?php echo $row['pn_23'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="23" type="button" id="23" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <input id="inputValue_0" class="form-control hr_input" type="number" name="value" style="min-width: 8rem;" />
                        <button onclick="getSnackbar(this, 0);" data-item='<?php echo $row['pn_0'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="0" type="button" id="0" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 1);" data-item='<?php echo $row['pn_1'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="1" type="button" id="1" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 2);" data-item='<?php echo $row['pn_2'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="2" type="button" id="2" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 3);" data-item='<?php echo $row['pn_3'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="3" type="button" id="3" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 4);" data-item='<?php echo $row['pn_4'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="4" type="button" id="4" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
                    ...
                    <td class="hourcell">
                        ...
                        <button onclick="getSnackbar(this, 5);" data-item='<?php echo $row['pn_5'] ?>' data-maquina="<?php echo $row['asset_id']; ?>" data-hr="5" type="button" id="5" class="tablahrxhr btn btn-raised-primary shadow-5 ripple-info w-100 m-auto d-block mt-1">Guardar</button>
                        <?php
