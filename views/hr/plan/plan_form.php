...
?>
<table class="table container text-center table-primary table-bordered mb-0 mt-3">
    <thead>
        <tr>
...
<div>
    <table class="table container text-center table-bordered mb-0 mt-4">
        ...
        <tbody>
            <tr>
                <th style="min-width: 9rem;" class="table-primary">6:00-7:00am</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_1" name="cum_plan">0</td>
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_1" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_1" disabled="true"></td>
                <td class="table-primary" style="min-width: 8rem;" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_1" value="" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">7:00-8:00am</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_2" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_2" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_2" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_2" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">9:00-10:00am</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_3" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_3" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_3" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_3" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">10:00-11:00am</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_4" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_4" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_4" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_4" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">11:00-12:00pm</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_5" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_5" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_5" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_5" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">12:00-13:00pm</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_6" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_6" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_6" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_6" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">13:00-14:00pm</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_7" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_7" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_7" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_7" disabled="true"></td>
            </tr>
            <tr>
                <th class="table-primary">14:00-15:30pm</th>
                <td id="hc" class="table-primary">
                ...
                <td class="table-primary" id="cum_plan_8" name="cum_plan">0</td>
                <td class="table-light">
                ...
                <td class="table-primary" id="less_time"><input type="text" name="less_time" id="less_time_8" disabled="true"></td>
                <td class="table-primary" id="stnd_time"><input type="text" name="stnd_time" id="stnd_time_8" disabled="true"></td>
                <td class="table-primary" id="qty_by_hr"><input type="text" name="qty_by_hr" id="qty_by_hr_8" disabled="true"></td>
            </tr>
        </tbody>
    </table>
