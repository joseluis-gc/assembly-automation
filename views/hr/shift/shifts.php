...
<div class="container">
    <div class="card card-raised">
        <div class="card-header bg-transparent px-4">
            <div class="d-flex justify-content-between align-items-center">
                <div class="me-4">
                    <?php if (isset($action) && $action == 'edit' ): ?>
                        <h2 class="card-title mb-0">Editing Shift</h2>
                    <?php else: ?>
                        <h2 class="card-title mb-0">Shifts</h2>
                    <?php endif; ?>
            ...
            <?php if (isset($action) && $action == 'edit' ): ?>
                action="index.php?page=shifts&action=update"
            <?php else: ?>
                action="index.php?page=shifts&action=insert"
            <?php endif; ?>          
            >
                <div class="row mb-4 mt-3">
                    ...
                    <div class="form-group col-md-4">
                        <label for="inputStartHour">Start Hour</label>
                        <input type="time" name="start_hour" class="form-control" id="inputStartHour"  
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="time" name="end_hour" class="form-control" id="inputEndHour"  
